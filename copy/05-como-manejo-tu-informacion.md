...
>
> ⚠️ **BLOQUEO PARCIAL — leer antes de construir.** La sección marcada como *pendiente* no puede
> publicarse todavía. El usuario opera hoy en un plan de consumidor, donde las sesiones se usan para
> entrenamiento salvo que se desactive, con retención de hasta cinco años. Esa sección se publica
> **solo después** de que migre a un plan comercial. Dejar el bloque comentado en el HTML.
...
## Nunca trabajo con datos de las personas que atiendes

No los pido, no los recibo y no los cargo en ninguna herramienta.
...
Cuando hay que analizar información de tu operación —inventarios, registros administrativos,
bitácoras— el procesamiento ocurre en mi equipo, no en un servicio externo.

<!-- PENDIENTE — NO PUBLICAR hasta migrar a plan comercial de IA

## Las herramientas que uso operan bajo términos comerciales

Las herramientas de inteligencia artificial que utilizo operan bajo términos comerciales que
prohíben el uso de la información para entrenar modelos. No uso planes de consumidor para trabajo
de cliente.

-->

## Qué te digo, y cuándo
...
pedir que algo quede expresamente fuera.

Si tu organización ya tiene una política de protección de datos, mándamela. La leo y me ajusto a
ella; no al revés.
...
Si tienes una pregunta que esta página no contesta, escríbeme y la contesto por escrito. Si la
pregunta es buena, la agrego aquí.
