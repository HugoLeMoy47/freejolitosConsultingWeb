# Inicio — versión B (más suelta) · NO PUBLICAR TODAVÍA

> Reserva para el A/B testing en el borde. **No construir esta versión ahora.**
> Misma estructura y mismos argumentos que la versión A; solo cambia el registro.
...
Tu organización creció. La tecnología creció con ella, pero sin plan.

Los archivos están regados entre computadoras, correos y una memoria que alguien se llevó. Nadie es
el responsable. Cuando algo truena, lo arregla quien esté a la mano.

Y ahora tu financiador pregunta cosas que antes no preguntaba: cómo cuidas los datos de las personas
que atiendes, si tienes respaldos, quién tiene acceso a qué.

Te miden como a una organización grande. Con el presupuesto de una chica.

## Lo que hago

Te traigo el estándar de las grandes, a tu escala. Porque cumplir no es lo mismo que gastar: la
mayor parte de lo que te van a pedir se arregla con orden, no con equipo nuevo.
...
El sistema que necesitas, probado en chiquito antes de que le metas dinero completo.
